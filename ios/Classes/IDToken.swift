...
class IDToken {
     ...
     */
    static let GIVEN_NAME: String = "given_name";
     ...
     * by space characters.
     */
    static let FAMILY_NAME: String = "family_name";
     ...
     */
    static let PREFERRED_USERNAME: String = "preferred_username";
     ...
     */
    static let ZONEINFO: String = "zoneinfo";
     ...
     * RFC 3966 format.
     */
    static let PHONE_NUMBER_VERIFIED: String = "phone_number_verified";
